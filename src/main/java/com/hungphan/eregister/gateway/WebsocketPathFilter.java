...
@Component
public class WebsocketPathFilter implements GatewayFilter, Ordered {
    ...
    private String eregisterWebsocketPort;
    ...
    public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
        ...
        String newUrl = "http://" + host + ":" + eregisterWebsocketPort + exchange.getRequest().getPath();
        URI uri = null;
        try {
            uri = new URI(newUrl);
